...
scr=./script/PDN_script/add_vdd_mesh.scr
h_length=1750.00
h_width=40.00
v_length=1750.00
v_width=40.00
...
echo -e "## Allegro VDD mesh script." > $scr
...
echo -e "\n" >> $scr
echo -e "## Set VDD layer" >> $scr
echo -e "generaledit" >> $scr
echo -e "\n" >> $scr
echo -e "## Set metal layer for VDD" >> $scr
echo -e "generaledit" >> $scr
...
do
	...
	echo -e "fillin\t\t\"Vdd\"" >> $scr
done

echo -e "\n" >> $scr
## Vertical.
echo -e "## Vertial VDD" >> $scr
echo -e "setwindow form.mini" >> $scr
